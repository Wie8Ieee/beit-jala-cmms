...
export const monthlyMaintenanceEvaluationReportsTable = pgTable("monthly_maintenance_evaluation_reports", {
  ...
  totalPmActivitiesIsOverride: boolean("total_pm_activities_is_override").notNull().default(false),
  completedPmOnTime: integer("completed_pm_on_time").notNull().default(0),
  completedPmOnTimeIsOverride: boolean("completed_pm_on_time_is_override").notNull().default(false),
  ...
  totalCorrectiveRequestsIsOverride: boolean("total_corrective_requests_is_override").notNull().default(false),
  unclosedCorrectiveRequests: integer("unclosed_corrective_requests").notNull().default(0),
  unclosedCorrectiveRequestsIsOverride: boolean("unclosed_corrective_requests_is_override").notNull().default(false),
  completedCorrectiveRequests: integer("completed_corrective_requests").notNull().default(0),
  completedCorrectiveRequestsIsOverride: boolean("completed_corrective_requests_is_override").notNull().default(false),
  ...
  totalExternalActivitiesIsOverride: boolean("total_external_activities_is_override").notNull().default(false),
